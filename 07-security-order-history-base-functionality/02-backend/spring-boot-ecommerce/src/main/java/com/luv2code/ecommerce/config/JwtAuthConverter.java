...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public AbstractAuthenticationToken convert(@NonNull Jwt jwt) {
        Collection<GrantedAuthority> authorities = Stream.concat(jwtGrantedAuthoritiesConverter.convert(jwt).stream(),
                ...
                return new JwtAuthenticationToken(jwt, authorities,getPrincipleClainName(jwt));
    }
    ...
    private Collection<? extends GrantedAuthority> extractResourceRoles(Jwt jwt) {
        ...
        //this is a constant in jwt.io change it later to be dynamic (as a variable in yaml)
